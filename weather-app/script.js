...
async function getWeatherByLocation(city){
    ...
    <div class="col-12 col-md-6 col-lg-4 mt-5">
      ...
      ${data.forecast.forecastday[1].day.maxtemp_c}°C / ${data.forecast.forecastday[1].day.maxtemp_f}°F<h5>
      ...
      ${data.forecast.forecastday[2].day.maxtemp_c}°C / ${data.forecast.forecastday[1].day.maxtemp_f}°F<h5>
